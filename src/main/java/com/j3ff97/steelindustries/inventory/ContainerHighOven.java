...
public class ContainerHighOven extends ContainerSI
{
    ...
    public ContainerHighOven(InventoryPlayer player, TileEntityHighOven tile)
    {
        ...
        this.addSlotToContainer(new SlotMachineInput(tile, 2, 8, 55));
        this.addSlotToContainer(new SlotMachineOutput(tile, 3, 116, 35));
    ...
    public void detectAndSendChanges()
    {
        ...
        for(int i = 0; i < this.crafters.size(); i++)
        {
            ...
            {
                crafting.sendProgressBarUpdate(this, 1, this.highOven.dualCookTime);
            }
