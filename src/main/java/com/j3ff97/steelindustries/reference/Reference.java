...
{
    public static final String ID = "SteelIndustries";
    public static final String NAME = "SteelIndustries";
    public static final String VERSION = "1.7.10-0.7";
    public static final String CLIENT_PROXY = "com.j3ff97.steelindustries.proxy.ClientProxy";
